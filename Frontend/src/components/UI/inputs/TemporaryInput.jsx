...
export default function Temporary({ activeTab, setActiveTab }) {
...
function OrderSummary({ itemsAdded, setItemsAdded }) {
  ...
  // Set default order date to current date/time when component mounts
  useEffect(() => {
    const now = new Date();
  ...
  const handleSavePending = async () => {
    const orderData = {
      ...
      total: total,
      order_date: orderDate, // Include the selected date
          ...
          <div className="form-control">
            ...
            <div className="relative">
              <input
                ...
                className="input bg-white text-slate-700 input-primary w-full pl-10"
              />
