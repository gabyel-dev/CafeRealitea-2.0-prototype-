...
import { FaTimes, FaUserPlus, FaEye, FaEyeSlash, FaCheckCircle, FaExclamationTriangle } from "react-icons/fa";
...
export default function CreateUserModal({ isOpen, onClose }) {
  ...
  return (
    <AnimatePresence>
    <motion.div
     className="fixed inset-0 z-50 overflow-y-auto backdrop-blur-sm bg-black/30 transition-all duration-300">
        ...
        >
          ...
          {status === 'success' && (
            <div className="mx-6 mt-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">The new user account has been created.</p>
              </div>
            </div>
          )}
          ...
          {status === 'error' && (
            <div className="mx-6 mt-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-center">
              ...
              <div>
                <p className="font-medium text-red-800">Failed to create user</p>
