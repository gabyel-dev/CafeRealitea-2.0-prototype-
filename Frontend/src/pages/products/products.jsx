            ...
            <div className="lg:pt-4 lg:py-4 lg:px-4 bg-indigo-50 min-h-screen">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-5 ">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">{totalProducts}</h3>
                            </div>
                        </div>
                        <div className="mt-3 pt-3 border-t border-gray-100">
                            <p className="text-xs text-gray-500">{uniqueCategories} categories</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-5  ">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">{categories.length}</h3>
                            </div>
                        </div>
                        <div className="mt-3 pt-3 border-t border-gray-100">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">
                                    {allProducts.filter(p => p.category.includes('Coffee')).length}
                                </h3>
                            </div>
                        </div>
                        <div className="mt-3 pt-3 border-t border-gray-100">
                ...
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                        {categories.map(category => (
                            <div key={category.category_id} className="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition-shadow">
