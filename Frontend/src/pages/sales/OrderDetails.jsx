    ...
    <div className="min-h-screen  bg-indigo-50 flex pt-0 lg:pt-0 ">
      <div className="lg:pt-4 lg:py-4 lg:px-4  min-h-screen w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-slate-700">Order Details</h1>
        ...
        <div className="flex justify-end gap-3 mt-6">
          <button className="flex items-center px-4 py-2 border border-slate-300 rounded-lg text-slate-700 hover:bg-white hover:border-slate-400 transition-colors">
