    ...
    const fetchUsers = async () => {
      try {
        const [usersRes, onlineRes] = await Promise.all([
          ...
          axios.get("https://caferealitea.onrender.com/online_users", {
            withCredentials: true,
          }),
        ]);
    ...
    <div className="min-h-screen bg-indigo-50 lg:p-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center pb-4 md:p-0">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold md:mb-4 text-gray-800">
            User Management
          </h1>
      ...
      <div className="hidden md:block">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div
            ...
            onClick={() =>
              setRoleFilter(roleFilter === "Staff" ? "all" : "Staff")
            }
          >
            <div className="stat">
          ...
          <div
            className={`stats shadow cursor-pointer transition-all hover:shadow-md ${
              roleFilter === "System Administrator"
          ...
          >
            <div className="stat">
              ...
              <div className="stat-value text-indigo-500">
                {
                  users.filter((user) => user.role === "System Administrator")
                    .length
                }
              </div>
            </div>
      ...
      <div className="card bg-white shadow-lg">
        <div className="card-body p-0">
          <div className="flex justify-between items-center p-4 md:p-6 border-b">
            <h2 className="card-title text-lg md:text-xl text-slate-700">
              User Accounts
            </h2>
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <div className="dropdown dropdown-bottom dropdown-end">
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content z-[1] menu p-2  bg-white border border-slate-300 shadow-lg rounded-box w-52"
                >
                  <li>
                  ...
                  <AnimatePresence>
                    {filteredUsers.map((user) => (
                      ...
                      >
                        ...
                        <td>
                          <div
                            className={`flex items-center w-fit gap-2 px-2 py-2 lg:px-3 lg:py-1 rounded-full text-xs font-medium ${getRoleColor(
                              user.role
                            )}`}
                          >
                        ...
                        <td>
                          <div
                            className={`flex items-center w-fit gap-2 px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(
                              isOnline[user.id] ?? false
                            )}`}
                          >
                            <div
