...
export default function Profile({ activeTab, setActiveTab }) {
  ...
  const handleSave = async () => {
    ...
    try {
      const api = import.meta.env.VITE_SERVER_API_NAME;
      await axios.post(`${api}/update/account`, profileData, {
        withCredentials: true,
      });
          ...
          <div className="card bg-white shadow-xl sticky top-4">
            <div className="card-body items-center text-center">
              ...
              <div className="relative mb-4">
                ...
                {isEditing && (
                  <label
                    ...
                    className="absolute bottom-0 right-0 bg-primary text-primary-content p-3 rounded-full cursor-pointer hover:bg-primary-focus transition-all shadow-md"
                  >
              ...
              <p className="text-sm  text-slate-700 opacity-70">
                Member since{" "}
                {new Date(profileData.joined_on).toLocaleDateString()}
              </p>
        ...
        <div className="lg:col-span-2 rounded-md">
          <div className="card bg-base-100 shadow-xl rounded-md">
            <div className="card-body bg-white  text-slate-700 rounded-md">
              ...
              <p className=" text-slate-700 opacity-70 mb-6">
